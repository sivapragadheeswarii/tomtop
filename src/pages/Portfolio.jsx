...
export default function Portfolio() {
  ...
  return (
    <div className="bg-[#FAF5FF] text-[#111827] min-h-screen">
      ...
      {/* 1. SECTION 1 — HEADER & INTRO (Enterprise SaaS Theme) */}
      <section className="relative min-h-[85vh] sm:min-h-screen flex flex-col justify-center items-center pt-28 pb-16 overflow-hidden border-b border-purple-100 bg-[#FAF5FF]">
        {/* Background Image Overlay: Laptop with dashboard UI, ERP software, analytics & mobile app mockups */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center justify-center my-auto w-full">
          ...
          >
            ...
            <span className="uppercase tracking-widest text-[11px]">Client Success & Enterprise Case Studies</span>
          </motion.div>
          ...
          >
            Software Solutions <span className="text-[#C084FC] font-extrabold drop-shadow-[0_2px_10px_rgba(168,85,247,0.5)]">Engineered For Impact & Scale</span>
          </motion.h1>
          ...
          >
            Explore our featured portfolio of industrial ERPs, cross-platform mobile apps, and high-concurrency corporate web applications.
          </motion.p>
