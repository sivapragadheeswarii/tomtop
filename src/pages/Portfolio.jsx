    ...
    <section className="py-12 sm:py-24 bg-white border-b border-blue-100 relative overflow-hidden text-[#111827]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-14">
          <span className="text-[#2563EB] font-bold text-[10px] sm:text-xs uppercase tracking-widest bg-blue-100 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full border border-blue-200 shadow-sm inline-flex items-center gap-2 mb-3 sm:mb-4">
...
export default function Portfolio() {
  ...
  return (
    <div className="bg-[#F0F7FF] text-[#111827] min-h-screen">
      ...
      <section className="py-12 sm:py-20 lg:py-28 bg-white border-b border-blue-100 relative overflow-hidden text-[#111827]">
          ...
          {FEATURED_CASE_STUDIES.map((study, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl sm:rounded-[32px] border border-blue-100 overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-0 shadow-xl shadow-blue-900/5 hover:border-[#60A5FA] transition-all duration-500 group"
              >
                {/* Image Panel */}
                <div
                ...
                >
                  ...
                  <span className="absolute top-3.5 left-3.5 sm:top-6 sm:left-6 text-[10px] sm:text-xs font-bold px-2.5 py-1 sm:px-3.5 sm:py-1.5 bg-white/90 backdrop-blur-md text-[#2563EB] rounded-full border border-blue-200 uppercase tracking-widest shadow-md">
                    {study.badge}
                  </span>
                </div>
                ...
                >
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] sm:text-xs font-bold text-[#2563EB] px-2.5 py-0.5 sm:px-3 sm:py-1 bg-blue-50 rounded-full border border-blue-200">
                        {study.category}
                      </span>
                    </div>

                    <h2 className="text-xl sm:text-3xl font-extrabold text-[#111827] tracking-tight leading-snug group-hover:text-[#2563EB] transition-colors">
                      {study.title}
                    </h2>
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-1">
                      {study.tech.map((t, idx) => (
                        <span
                          key={idx}
                          className="text-[10px] sm:text-xs font-semibold px-2.5 py-0.5 sm:px-3 sm:py-1 bg-blue-50 text-[#2563EB] rounded-lg border border-blue-200"
                        >
                          {t}
                        </span>
                      ))}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-3 sm:pt-4 border-t border-blue-100 text-xs">
                      <div className="space-y-1 p-3 sm:p-3.5 rounded-xl bg-blue-50/50 border border-blue-100">
      ...
      {/* 3. SECTION 3 — RECENT PROJECTS (Soft Blue Background) */}
      <section className="py-12 sm:py-24 bg-[#F0F7FF] border-b border-blue-100 relative overflow-hidden text-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-16">
            <span className="text-[#2563EB] font-bold text-[10px] sm:text-xs uppercase tracking-widest bg-blue-100 px-3.5 py-1 rounded-full border border-blue-200 shadow-sm">
            ...
            {recentProjects.map((project, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`${spanClass} bg-white rounded-2xl sm:rounded-[28px] border border-blue-100 overflow-hidden group hover:border-[#60A5FA] hover:shadow-xl shadow-lg shadow-blue-900/5 transition-all duration-300 cursor-pointer flex flex-col justify-between`}
                >
                  <div className="relative aspect-[16/9] overflow-hidden bg-blue-50">
                    ...
                    <span className="absolute top-3.5 left-3.5 sm:top-4 sm:left-4 text-[9px] sm:text-[10px] font-bold px-2.5 py-0.5 sm:px-3 sm:py-1 bg-white/90 backdrop-blur-md text-[#2563EB] rounded-full border border-blue-200 uppercase tracking-widest shadow-sm">
                      {project.category}
                    </span>
                  </div>

                  <div className="p-5 sm:p-8 space-y-2.5 sm:space-y-3">
                    <h3 className="text-lg sm:text-xl font-extrabold text-[#111827] group-hover:text-[#2563EB] transition-colors leading-snug">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      {project.tech.map((t, idx) => (
                        <span key={idx} className="text-[9px] sm:text-[10px] font-bold px-2 py-0.5 sm:px-2.5 sm:py-1 bg-blue-50 text-[#2563EB] rounded-md border border-blue-200">
                          {t}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="px-5 py-3 sm:px-6 sm:py-4 border-t border-blue-100 flex items-center justify-between bg-blue-50/50">
                    <span className="text-[10px] sm:text-xs font-semibold text-slate-500">Client: {project.client}</span>
                    <button className="text-[10px] sm:text-xs font-bold text-[#2563EB] group-hover:text-[#1D4ED8] flex items-center space-x-1 transition-colors">
          ...
          <div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-16">
            {SUCCESS_METRICS.map((met, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -4 }}
                className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-white border border-blue-100 backdrop-blur-2xl text-center shadow-lg shadow-blue-900/5"
              >
                <span className="text-2xl sm:text-4xl font-extrabold text-[#2563EB] font-mono block mb-1">
                  {met.value}
                </span>
              ...
              >
                ...
                <div className="pt-3.5 sm:pt-4 border-t border-blue-100 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] sm:text-xs text-[#2563EB] font-medium">{t.role} • {t.company}</p>
                  </div>
