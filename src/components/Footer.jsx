...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1E3A8A] text-blue-200 pt-16 pb-8 border-t border-blue-800/60 relative overflow-hidden">
      {/* Ambient Lighting */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-blue-800/80">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-blue-200/90 text-xs sm:text-sm leading-relaxed max-w-sm">
            ...
            <div className="flex items-center space-x-2.5 pt-2">
              <a
                ...
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-xl bg-blue-900/60 hover:bg-[#2563EB] text-blue-200 hover:text-white flex items-center justify-center transition-all duration-300 border border-blue-700/60"
              >
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex flex-col space-y-2 md:hidden">
              <a href={`tel:${companyInfo.phone}`} className="flex items-center space-x-2.5 bg-blue-900/60 border border-blue-700/60 rounded-xl px-3 py-2.5 hover:border-[#60A5FA]/40 transition-colors">
                <Phone className="w-3.5 h-3.5 text-[#60A5FA] shrink-0" />
                <span className="text-xs font-semibold text-white">{companyInfo.phone}</span>
              </a>
              <a href={`mailto:${companyInfo.email}`} className="flex items-center space-x-2.5 bg-blue-900/60 border border-blue-700/60 rounded-xl px-3 py-2.5 hover:border-[#60A5FA]/40 transition-colors overflow-hidden">
              ...
              <a href={`https://${companyInfo.website}`} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2.5 bg-blue-900/60 border border-blue-700/60 rounded-xl px-3 py-2.5 hover:border-[#60A5FA]/40 transition-colors">
        ...
        {/* Copyright Bar */}
        <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-blue-300/80 gap-2 sm:gap-4">
